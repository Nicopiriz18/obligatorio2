...
public class VentanaRegistro extends javax.swing.JFrame {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if (nombreTematica.getText().isEmpty() || descripcionTematica.getText().isEmpty()) {
            JOptionPane.showMessageDialog(VentanaRegistro.this, "Debe llenar ambos campos.", "Error", JOptionPane.ERROR_MESSAGE);
        } else if(modelo.nombreEsUnico(nombreTematica.getText())){
            JOptionPane.showMessageDialog(VentanaRegistro.this, "El nombre debe ser unico", "Error", JOptionPane.ERROR_MESSAGE);
        }else {
